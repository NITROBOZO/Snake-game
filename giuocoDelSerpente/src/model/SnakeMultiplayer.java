...
public class SnakeMultiplayer {
	/*
	 * classe per gestire la logica tra serpenti, mele e le variabili di gioco
	 * principali
	 */
	...
	public boolean appleCollision() {
		if (multiplayer) {
			...
			if (snakes[0].isAppleCollision(apples[0].getApplePos())
					|| snakes[0].isAppleCollision(apples[1].getApplePos())) {
			...
			// P2 tocca la mela
			else if (snakes[1].isAppleCollision(apples[0].getApplePos())
					|| snakes[1].isAppleCollision(apples[1].getApplePos())) {
	...
	public boolean isAppleCollision() {
		...
		if (multiplayer) {
			if (snakes[0].isAppleCollision(apples[0].getApplePos())
					|| snakes[0].isAppleCollision(apples[1].getApplePos())) {// P1 tocca la mela
				return true;
			} else if (snakes[1].isAppleCollision(apples[0].getApplePos())
					|| snakes[1].isAppleCollision(apples[1].getApplePos())) {// P2 tocca la mela
				return true;
			}
		}
